...
$tableNameNew = 'suggestions';
$questionsNew = mysqli_query($connection, "SELECT * FROM `$tableNameNew`");
...
<div class="admin-panel">
	...
	<div class="container">
		<div class="form-wrapper d-block">
			<div class="form-question form-question_new">
				...
				<div class="table-wrap">
					<table class="table-question_show">
						...
						<?php
							while ($question = mysqli_fetch_assoc($questionsNew)){
								?>
									<tbody>
										<tr>
											...
											<td class="show-buttons table-small-col">
												<form action="../delete-question.php?backTo=new" method="post">
													<input type="hidden" name="id" value="<?= $question["id"] ?>">
													<input type="hidden" name="tableName" value="<?= $tableNameNew ?>">
													<input type="hidden" name="item" value="Вопрос">
													<button type="submit" class="btn-show btn-show-delete btn-new-delete">Удалить</button>
												</form>
												<form action="../move-question.php" method="post">
													<input type="hidden" name="id" value="<?= $question["id"] ?>">
													<button type="submit" class="btn-show btn-new-add">Добавить</button>
												</form>
												<a href="../edit-question.php?id=<?= $question["id"] ?>&tableName=<?= $tableNameNew ?>&check=false&backTo=new" class="btn-show btn-show-edit">Редактировать</a>
											</td>
										</tr>
									</tbody>
								<?php
